...
- Options
  - onSuccess, onError, retry (maxAttempts, delay, backoff, shouldRetry), autoReset (enabled, delay), loading (minDuration, delay), concurrency ("keep" | "restart" | "enqueue"), debounce, throttle, optimisticResult
