...
## Core Components
- ButtonHelperOptions interface: Extends ButtonHTMLAttributes<HTMLButtonElement>, enabling full HTML button attribute support while allowing additional data-* and aria-* attributes.
...
- Allows arbitrary keys: Enables data-* and aria-* attributes for advanced customization.
