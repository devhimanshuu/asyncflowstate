  ...
  return (
    ...
    >
      ...
      >
        {events.length === 0 && (
          <div
            style={{ color: "#666", textAlign: "center", marginTop: "150px" }}
          >
        ...
        {view === "list" ? (
          events.map((event) => (
            <div
              key={`${event.flowId}-${event.timestamp}`}
              style={{
                marginBottom: "8px",
                padding: "8px",
                background: "#252526",
            ...
            >
              ...
              <div style={{ color: "#eee", fontWeight: 500 }}>
                {event.flowName}{" "}
          ...
          <div style={{ position: "relative", minHeight: "100%" }}>
            {timelineData.map((flow) => {
              const left =
                (((flow.start || minTime) - minTime) / duration) * 100;
              const width = Math.max(
                (((flow.end || maxTime) - (flow.start || minTime)) / duration) *
                  100,
                0.5,
              );
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "5px" }}>
          <div
            style={{
              ...
              height: "8px",
              borderRadius: "50%",
              background: getStatusColor("start"),
            }}
          ></div>{" "}
          Start
        </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "5px" }}>
          <div
            style={{
              ...
              height: "8px",
              borderRadius: "50%",
              background: getStatusColor("retry"),
            }}
          ></div>{" "}
          Retry
        </div>
