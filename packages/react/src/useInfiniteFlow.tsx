...
import { FlowAction, FlowOptions, FlowState } from "@asyncflowstate/core";
import { useFlow } from "./useFlow";

export interface InfiniteFlowOptions<TData, TError, TArgs extends any[]>
...
export interface InfiniteFlowResult<TData, TError, TArgs extends any[]> {
    pages: TData[];
    pageParams: any[];
