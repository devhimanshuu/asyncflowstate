 ...
 */
import { ref } from 'vue';
import { useFlow, useFlowSequence, useFlowParallel, provideFlowConfig } from '@asyncflowstate/vue';
import { z } from 'zod';
...
<template>
  <div class="examples">
    ...
    <section>
      ...
      <button v-bind="fetchUserFlow.button()" @click="fetchUserFlow.execute('123')">
    ...
    <section>
      ...
      <form v-bind="loginFlow.form({ schema: formSchema, extractFormData: true })">
        <div>
          <label>Email</label>
